\chapter{Specifikacija programske potpore}
	...
	\end{packed_item}		
				...
				\subsubsection{Dijagrami obrazaca uporabe}
					...
					\begin{figure}[H]
						\includegraphics[scale=0.4]{slike/svi_korisnici.jpg}
						\centering
					...
					\end{figure}
			     	...
			     	\begin{figure}[H]
				     	\includegraphics[scale=0.4]{slike/administrator.jpg}
				    	\centering
		        	...
		        	\begin{figure}[H]
			        	\includegraphics[scale=0.4]{slike/sluzbenik_kredit.jpg}
			        	\centering
				    ...
				    \begin{figure}[H]
				    	\includegraphics[scale=0.4]{slike/klijent.jpg}
				    	\centering
			        ...
			        \begin{figure}[H]
			        	\includegraphics[scale=0.4]{slike/neregistrirani_klijent.jpg}
			        	\centering
