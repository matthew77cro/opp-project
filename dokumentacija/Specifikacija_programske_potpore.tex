	...
	\section{Funkcionalni zahtjevi}
            ...
            \end{packed_item}
               ...
               \noindent \underbar{\textbf{UC11 - Otvaranje transakcijskog računa}}
                ...
                \noindent \underbar{\textbf{UC18 - Blokiranje kreditnih zahtjeva}}
                \begin{packed_item}
                  ...
                  \item[] \begin{packed_enum}
                    ...
                    \noindent \underbar{\textbf{UC19 - Blokiranje kreditnih zahtjeva}}
                    \begin{packed_item}
                ...
                \noindent \underbar{\textbf{UC20 - Uvid u podatke o klijentu}}
                \begin{packed_item}
    			...
    			\noindent \underbar{\textbf{UC28-Pregled transakcijskih računa }}
    		\begin{packed_item}
    		...
    		\noindent \underbar{\textbf{UC29-Pregled štednih računa }}
    	\begin{packed_item}
    	...
    	\end{packed_item}
		    ...
		    \noindent \underbar{\textbf{UC30-Pregled kredita }}
		    \begin{packed_item}
		    ...
		    \end{packed_item}
		      ...
		      \noindent \underbar{\textbf{UC31-Pregled kartica }}
		    \begin{packed_item}
		    ...
		    \end{packed_item}
    			...
    			\noindent \underbar{\textbf{UC32-Pregled podataka o transakcijama }}
    			\begin{packed_item}
    			...
    			\noindent \underbar{\textbf{UC33-Prijenos sredstava između vlastitih računa }}
    			\begin{packed_item}
    			...
    			\end{packed_item}
    				...
    				\noindent \underbar{\textbf{UC34-Prijenos sredstava na račun drugih klijenata }}
    			\begin{packed_item}
    		...
    		\noindent \underbar{\textbf{UC35-Ručno izvršavanje uplate kredita }}
    		\begin{packed_item}
    		...
    		\noindent \underbar{\textbf{UC36-Ručno izvršavanje uplate na kreditnu karticu }}
    	\begin{packed_item}
    		
    		\item \textbf{Glavni sudionik: }Klijent
    		\item  \textbf{Cilj:} Smanjenje duga
    		\item  \textbf{Sudionici:} Baza podataka
    		\item  \textbf{Preduvjet:} Klijent je prijavljen
    		\item  \textbf{Opis osnovnog tijeka:}
    	...
    	\end{packed_item}
    		...
    		\noindent \underbar{\textbf{UC37-Podnošenje zahtjeva za kreditom }}
    		\begin{packed_item}
    		...
    		\noindent \underbar{\textbf{UC38-Podnošenje zahtjeva za kreditnom karticom }}
    	\begin{packed_item}
    	...
    	\end{packed_item}
    			...
    			\noindent \underbar{\textbf{UC39-Zahtjev za sastankom s bankarom }}
    			\begin{packed_item}
    			...
    			\end{packed_item}
    				...
    				\noindent \underbar{\textbf{UC40-Registracija korisnika  }}
    			\begin{packed_item}
			...
			\noindent \underbar{\textbf{UC41-Odabir korisničkog imena i lozinke  }}
		\begin{packed_item}
			...
			\item[] \begin{packed_enum}
				...
				\item Aplikacija provjerava valjanost unesenih podataka
				\item Aplikacija javlja uspješnost prijave korisnika i sprema korisnika u bazu podataka
			...
			\item[] \begin{packed_item}
				...
				\item[2.a] Unos već postojećih podataka
				\item[] \begin{packed_enum}
