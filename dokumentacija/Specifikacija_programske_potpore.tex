\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\noindent \underbar{\textbf{UC2-Pregled svih korisnika sustava }}
				\begin{packed_item}
					...
					\item[] \begin{packed_enum}
						...
						\item Prikazuje se lista svih ispravno registriranih korisnika
		   	...
		   	\noindent \underbar{\textbf{UC3-Dodavanje novih djelatnika }}
				\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Administrator unosi potrebne osobne podatke djelatnika i novo korisničko ime
							\item Sustav generira privremenu lozinku za djelatnika i ispisuje ju administratoru
						...
						\item[] \begin{packed_item}
							...
							\item[1.a] Unos neispravnih podataka (krivi OIB, korisničko ime već postoji i dr.)
							\item[] \begin{packed_enum}
				...
				\begin{packed_item}
					...
					\item[] \begin{packed_enum}
						...
						\item Administrator pronalazi željenog djelatnika u popisu svih korisnika sustava
			...
			\begin{packed_item}
				...
				\item[] \begin{packed_enum}
					...
					\item Administrator odabire željenog korisnika u popisu svih korisnika sustava
			...
			\noindent \underbar{\textbf{UC6 - Promjena razine pristupa }}
			\begin{packed_item}
				...
				\item[] \begin{packed_enum}
					...
					\item Izmijeni razinu pristupa korisnika i sprema promjenu u bazu podataka
            ...
            \begin{packed_item}
                ...
                \noindent \underbar{\textbf{UC12 - Brisanje korisničkog profila (računa) klijenta }}
                \begin{packed_item}
