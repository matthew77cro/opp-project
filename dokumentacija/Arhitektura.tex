\chapter{Arhitektura i dizajn sustava}
	...
	\end{longtabu}
		...
		\textbf{Štedni račun}   Ovaj entitet sadrži sve važne informacije o štednom računu. Sadrži atribute: broj računa, broj vrste računa, kamatna stopa i datum zatvaranja. U vezi je \textit{Many-to-One} s entitetom Račun preko broja računa i u vezi \textit{One-to-One} s entitetom Vrsta računa preko broja vrste računa. 
